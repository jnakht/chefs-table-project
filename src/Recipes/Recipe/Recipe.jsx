    ...
    return (
        <div>
            <div className="card bg-base-100 w-96 shadow-xl">
                ...
                {/* after image */}
                <div>
                    <h3 className="text-[#282828] text-xl font-semibold font-lexend">{recipe_name}</h3>
                    ...
                    <div className='border-t border-b border-[#E6E6E6]'>
                        <h3 className='text-[#282828] font-lexend text-lg font-medium'>Ingredients: {ingredients.length}</h3>
                        <ul className='text-[#878787] font-firaSans text-lg font-normal'>
                            {
                    ...
                    {/*  last div*/}
                    <div>
                        <div className='flex gap-4 text-[#878787] font-firaSans text-lg font-normal'>
                            <div className='flex'>
                        ...
                        <button className='btn bg-[#0BE58A] hover:bg-slate-500 pl-3 pr-3 pt-3 pb-3 h-[56px] rounded-[50px] w-[170px]'>Want to Cook</button>
                    </div>
                </div>
            </div>
        </div>
